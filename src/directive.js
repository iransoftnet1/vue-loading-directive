import Vue from 'vue'
import Loading from './views/_loading'
import Packmna from '@/components/Loading.vue'
const Mask = Vue.extend(Loading)
// const Mask = Vue.extend(Packmna)
import {merge,afterLeave ,addClass, removeClass, getStyle} from './utils'
...
loadingDirective.install = Vue => {
  ...
  const insertDom = (parent, el, binding) => {
    ...
    if (parent && parent.classList.contains('el-dialog__wrapper')) {
      parent = parent.querySelector('.el-dialog')
    }
